...
//# sourceMappingURL=jquery.min.map/* Modernizr 2.8.3 (Custom Build) | MIT & BSD
...
})( window );// Generated by CoffeeScript 1.6.2
/*
...
"-webkit-transform:"+b+";-moz-transform:"+b+";transform:"+b+";"}};(function(){g=window.innerHeight;l();for(var a=0;a<c.elems.length;a++){var b=p(c.elems[a]);d.push(b)}window.addEventListener("resize",function(){k()});m();k()})();Object.freeze();return c}};return e});// Macs have smooth scrolling already. This is only for Windows.
